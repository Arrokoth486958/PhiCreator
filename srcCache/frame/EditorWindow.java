...
import dev.arrokoth.phicreator.editor.icon.FlatPlayIcon;
...
import dev.arrokoth.phicreator.phi.simulator.Simulator;
...
public class EditorWindow {
    ...
    public EditorWindow() {
        try {
            ...
            frame.setTitle(String.format(LocalizationManager.getString("TITLE_MAIN"), PhiCreator.VERSION));
