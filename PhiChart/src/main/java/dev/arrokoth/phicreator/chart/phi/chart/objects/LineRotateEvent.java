 ...
 */
public class LineRotateEvent implements LineEvent {
    ...
    public LineRotateEvent(double startTime, double endTime, double start, double end, double start2, double end2) {
